...
Both the PyPI and TestPyPI Trusted Publishers, and the corresponding GitHub Environments, must be configured by a repository admin **before** either workflow is used — this is a one-time, human-performed setup step and is not automated by these workflows. See [docs/how-to/publish-a-taurcode-release.md](docs/how-to/publish-a-taurcode-release.md) for the full setup and release-sequencing checklist.
